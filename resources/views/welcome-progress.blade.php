...
.jumbotron-fluid {
    width: 100%;
    background: #ffffffd6;
    box-shadow: 0 0 20px 2px #3b3c53;
}
.display-4 {
...
body {
    background-color: #181b60 !important;
    /* background-image: url(assets/bg.jpg); */
    background-position: center top;
    background-size: cover;
    font-family: 'Noto Sans JP', sans-serif;
}
.card {background-color: #fffa;}
</style>
...
<div style="width:100%">
    ...
    <div class="jumbotron jumbotron-fluid">
        <div class="container">
            <h1 class="display-4">PROGRESS TWITTER SEARCH</h1>
            <p class="lead mb-5">PROGRESS専用Twitterアカウント検索サービス</p>
            ...
            <div class="card p-3 bg-warning text-white text-center mb-0">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body">
                                <div>
                                    <h4 class="card-title mb-0">サロン専用Twitter関連情報</h4>
                                    <div class="small text-muted">About Salon Twitter</div>
                                </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="card">
                        <div class="card-body">
                            <div>
                                <h4 class="card-title mb-0">お問い合わせ</h4>
                                <div class="small text-muted">Contact</div>
                            </div>

                            <p class=" mt-3">開発状況ややっていることなどをTwitterにて配信しています。フォローしていただけると励みになります。</p>
